"""
Django settings for vehicloud_api project.
...
ALLOWED_HOSTS = ['vehicloud.herokuapp.com','127.0.0.1', 'localhost']
...
ROOT_URLCONF = 'vehicloud_api.urls'
...
WSGI_APPLICATION = 'vehicloud_api.wsgi.application'
